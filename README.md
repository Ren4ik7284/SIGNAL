...
SIGNAL - независимый веб-плеер для прослушивания музыки, плейлистов и онлайн-радио без рекламы и без необходимости использовать VPN. Все аудиопотоки проксируются через бэкенд.
